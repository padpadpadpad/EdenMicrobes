...
|           | paired   |          | ngs_filtered |          | curated  |          | uniq    |          | no_singletons |          | PCRs above threshold (>1000) | Contaminent Removal |     |
| --------- | -------- | -------- | ------------ | -------- | -------- | -------- | ------- | -------- | ------------- | -------- | ---------------------------- | ------------------- | --- |
| Stage     | ASV      | Reads    | ASV          | Reads    | ASV      | Reads    | ASV     | Reads    | ASV           | Reads    |                              |  Extraction         | PCR | Sequencing |
