...
-   **Eden_soil_chem_data_nov23.csv** contains nutrient and chemical composition data for each sample. A breakdown of all the column names and their units is below:
...
This project is primarily a collaboration between Daniel Padfield ([d.padfield\@exeter.ac.uk](mailto:d.padfield@exeter.ac.uk){.email}) at the University of Exeter and Julian Donald (formerly of the Eden Project).
